...
(async () => {
   ...
   * DESPUÉS. Así la fila convertida queda con número alto sobre id bajo, que
   * es lo que hacía perder el hilo al generador. Convertirla enseguida no
   * reproduce nada.
   */
  ...
  chk('número más alto que la venta previa', true,
